...
class AsyncAppSearch(BaseClient):
    ...
    @_rewrite_parameters()
    async def get_adaptive_relevance_settings(
        self,
        *,
        engine_name: str,
    ) -> ObjectApiResponse[t.Any]:
    ...
    async def put_adaptive_relevance_settings(
        self,
        *,
        engine_name: str,
    ...
    async def list_adaptive_relevance_suggestions(
        self,
        *,
        engine_name: str,
    ...
    async def put_adaptive_relevance_suggestions(
        self,
        *,
        engine_name: str,
        body: t.Union[
    ...
    async def get_adaptive_relevance_suggestions(
        self,
        *,
        engine_name: str,
    ...
    @_rewrite_parameters()
    async def refresh_adaptive_relevance_update_process(
        self,
        *,
        engine_name: str,
    ...
    async def get_top_clicks_analytics(
        self,
        *,
        engine_name: str,
        current_page: t.Optional[int] = None,
    ...
    async def get_crawler_url_extraction_result(
        self,
        *,
        engine_name: str,
        body: str,
    ...
    async def create_crawler_crawl_request(
        self,
        *,
        engine_name: str,
    ...
    @_rewrite_parameters()
    async def list_crawler_crawl_requests(
        self,
        *,
        engine_name: str,
        current_page: t.Optional[int] = None,
    ...
    @_rewrite_parameters()
    async def get_crawler_crawl_request(
        self,
        *,
        engine_name: str,
    ...
    @_rewrite_parameters()
    async def get_crawler_active_crawl_request(
        self,
        *,
        engine_name: str,
    ) -> ObjectApiResponse[t.Any]:
    ...
    @_rewrite_parameters()
    async def delete_crawler_active_crawl_request(
        self,
        *,
        engine_name: str,
    ) -> ObjectApiResponse[t.Any]:
    ...
    async def create_crawler_crawl_rule(
        self,
        *,
        engine_name: str,
        domain_id: str,
    ...
    async def put_crawler_crawl_rule(
        self,
        *,
        engine_name: str,
        domain_id: str,
    ...
    @_rewrite_parameters()
    async def delete_crawler_crawl_rule(
        self,
        *,
        engine_name: str,
        domain_id: str,
    ...
    @_rewrite_parameters()
    async def get_crawler_crawl_schedule(
        self,
        *,
        engine_name: str,
    ) -> ObjectApiResponse[t.Any]:
    ...
    async def put_crawler_crawl_schedule(
        self,
        *,
        engine_name: str,
        frequency: int,
    ...
    @_rewrite_parameters()
    async def delete_crawler_crawl_schedule(
        self,
        *,
        engine_name: str,
    ) -> ObjectApiResponse[t.Any]:
    ...
    @_rewrite_parameters()
    async def get_crawler_process_crawl_denied_urls(
        self,
        *,
        engine_name: str,
    ...
    @_rewrite_parameters()
    async def list_crawler_domains(
        self,
        *,
        engine_name: str,
        current_page: t.Optional[int] = None,
    ...
    async def create_crawler_domain(
        self,
        *,
        engine_name: str,
    ...
    @_rewrite_parameters()
    async def delete_crawler_domain(
        self,
        *,
        engine_name: str,
        domain_id: str,
    ...
    async def create_crawler_entry_point(
        self,
        *,
        engine_name: str,
        domain_id: str,
    ...
    async def put_crawler_entry_point(
        self,
        *,
        engine_name: str,
        domain_id: str,
    ...
    @_rewrite_parameters()
    async def delete_crawler_entry_point(
        self,
        *,
        engine_name: str,
        domain_id: str,
    ...
    async def create_crawler_process_crawl(
        self,
        *,
        engine_name: str,
    ...
    @_rewrite_parameters()
    async def list_crawler_process_crawls(
        self,
        *,
        engine_name: str,
        current_page: t.Optional[int] = None,
    ...
    @_rewrite_parameters()
    async def get_crawler_process_crawl(
        self,
        *,
        engine_name: str,
        process_crawl_id: str,
    ...
    async def create_crawler_sitemap(
        self,
        *,
        engine_name: str,
        domain_id: str,
    ...
    @_rewrite_parameters()
    async def delete_crawler_sitemap(
        self,
        *,
        engine_name: str,
        domain_id: str,
    ...
    async def get_crawler_url_tracing_result(
        self,
        *,
        engine_name: str,
        body: str,
    ...
    async def get_crawler_url_validation_result(
        self,
        *,
        engine_name: str,
        body: str,
    ...
    async def get_crawler_domain_validation_result(
        self,
        *,
        body: str,
    ) -> ObjectApiResponse[t.Any]:
    ...
    async def delete_meta_engine_source(
        self,
        *,
        engine_name: str,
        source_engines: t.Optional[t.Union[t.List[str], t.Tuple[str, ...]]] = None,
    ...
    async def add_meta_engine_source(
        self,
        *,
        engine_name: str,
        source_engines: t.Optional[t.Union[t.List[str], t.Tuple[str, ...]]] = None,
